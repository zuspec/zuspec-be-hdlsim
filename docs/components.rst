...
* Python proxy generated via `PyHDL-IF <https://fvutils.github.io/pyhdl-if>`_
...
* Use `PyHDL-IF <https://fvutils.github.io/pyhdl-if>`_ logging to trace Python/SV communication
